import { getToken, getUrlParam, mainURL } from "../../utils/shared.js";
...
const renderMap = mapView => {
  let map = L.map("map-pre").setView([mapView.x, mapView.y], 13)
...
const deletePost = async () => {
  const deleteReq = await fetch(`${mainURL}/post/${post._id}`, {
    method: "DELETE",
    headers: {
